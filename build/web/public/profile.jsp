...
<section class="engine"><a href="https://mobirise.me/s">bootstrap themes</a></section>
    ...
    <div class="container">   
        ...
        <div class="media-container-row title">
           ...
           <div class="card p-3 col-12 col-md-6 col-lg-4" id>
                   ...
                   <p>Name:</p>
                    <div data-for="name">
                        <div class="form-group">
                            <input type="text" class="form-control px-3" name="name" data-form-field="name" value="<% out.println(rs.getString("name")); %>" required="" id="name-header15-1g">
                        </div>
                    </div>
                    <p>Display Name:</p>
                    <div data-for="eName">
                        <div class="form-group">
                            <input type="text" class="form-control px-3" name="dName" data-form-field="dName" value="<% out.println(rs.getString("displayName")); %>" required="" id="name-header15-1g">
                        </div>
                    </div>
                    <p>Address:</p>
                    <div data-for="address">
                        <div class="form-group">
                            <input type="text" class="form-control px-3" name="address" data-form-field="address" value="<% out.println(rs.getString("address")); %>" required="" id="name-header15-1g">
                        </div>
                    </div>
                    <p>Email:</p>
                    <div data-for="email">
                        <div class="form-group">
                            <input type="text" class="form-control px-3" name="email" data-form-field="email" value="<% out.println(rs.getString("email")); %>" required="" id="name-header15-1g">
                        </div>
                    </div>
                    <p>Phone:</p>
                    <div data-for="phone">
                        <div class="form-group">
                            <input type="text" class="form-control px-3" name="phone" data-form-field="phone" value="<% out.println(rs.getString("phone")); %>" required="" id="name-header15-1g">
                        </div>
                    </div>
                    ...
                    <button href="" type="submit" class="btn btn-secondary btn-form display-4">Edit Profile</button>
                </span>
                </form>
            </div>
        </div>
